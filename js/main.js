...
var tag = [
  ...
  "수능끝나고_신나게놀기", "수능끝나고_여행가기", "수능끝나고_영화보기", "수능끝나고_드라마보기", "수능끝나고_외식하기", "수능끝나고_게임하기", "실패란_넘어지는것이아니라_넘어진자리에머무는것", "개쩌는_사이보그_솔개를_본받으십시오", "시간은_우리를_기다려주지_않아", "세상에_쉬운건없다_근데_못할것도없다", "고개를들고_세상을바라봐", "길을아는것과_그길을걷는것_분명히다르다", "우리가습관을만들면_습관이우리를만든다", "많이하지말고_잘해라", "하고싶은일은_해야하는일다음에", "남에게_상처주지마", "응애_나_애기_고3",
];
