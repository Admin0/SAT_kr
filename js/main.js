...
var tag = [
  ...
  "대학문은좁지만_우리는날씬하다", "대학가서미팅할래_공장가서미싱할래?", "삼십분더공부하면_남편직업이바뀐다", "10분더공부하면_마누라가바뀐다", "배워서_남_주자", "이거볼시간있으면_영단어를외워", "네_성적에_잠이_오냐?", "공부가제일쉬웠어요", "국영수위주로_예습복습철저히", "내가꿈을이루면_난다시누군가의꿈이된다", "R=VD","카르페 디엠",
  "그얼굴이면_공부라도잘해야지", "엄마가_보고있다", "성적보다_꿈을이루자", "아침을_먹자", "생존", "방_치우기가_제일_재밌어지는_시간", "공부의_신", "겁쟁이는_변명도_많다", "인싸가되자", "해시태그추천받음", "만약우리가통속의뇌라면?",
  ...
  "화공과=육각형잘그림", "공대생=체크남방입고다님", "컴공과=세미콜론집착", "컴공과=사실컴고칠줄잘모름", "컴공과=치킨집사장예약", "의예과=공부잘함", "회화과=초상화잘그림", "경영과=교수주식투자망함", "공예과=앞치마", "철학과=자퇴추천", "회계과=총무의저주", "법학과=TV에과실얘기나오면입꾹다뭄", "서울의대랑길가다부딪히면_암설의", "연세의대랑길가다부딪히면_고의아님",
