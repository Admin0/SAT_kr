...
var tag = [
  "수능", "대학수학능력시험", "디데이", "D-day", "공부", "열공", "빡공", "대학가면남친생김?", "대학가면여친생김?", "응_아니야", "넌할수있어", "고3",

  "정시파이터", "상남자특_정시지원", "100일의_전사_가즈아", "노베이스_50일의_전사_가즈앗", "오버워치한판만", "공부해이것들아", "군대나갈까", "아조씨는08학번이야", "2호선을타자", "한숨자고해볼까", "문송합니다", "이과_죽었으면", "문돌이는답이없다", "아는것이힘이다", "변화외에_불변하는것은_없다", "인내해라", "이루어라", "네가선택한정시지원이다_악으로깡으로버텨라",

  "대학문은좁지만_우리는날씬하다", "대학가서미팅할래_공장가서미싱할래?", "삼십분더공부하면_남편직업이바뀐다", "10분더공부하면_마누라가바뀐다", "배워서_남_주자", "이거볼시간있으면_영단어를외워", "네_성적에_잠이_오냐?", "공부가제일쉬웠어요", "국영수위주로_예습복습철저히", "내가꿈을이루면_난다시누군가의꿈이된다", "R=VD", "카르페디엠", "하쿠나마타타", "응원할게", "네가최고다", "믿는다_너니까", "힘들땐_엄마얼굴생각해", "조금쉬어도괜찮아", "꺼지지않는_불꽃처럼", "정신은날카롭게_마음은여유롭게", "고마워얘들아", "공부의고통잠깐_못배운고통평생", "오늘걷지않으면_내일뛰어야한다", "학벌이돈이다_공부가투자다", "고통이란_되어간다는증거", "불가능이란_해보지않은자의변명", "인내는쓰지만_그열매는달다", "초심으로", "이루기위해서_미루지말자",
  ...
  "수능끝나고_신나게놀기", "수능끝나고_여행가기", "수능끝나고_영화보기", "수능끝나고_드라마보기", "수능끝나고_외식하기", "수능끝나고_게임하기", "실패란_넘어지는것이아니라_넘어진자리에머무는것", "개쩌는_사이보그_솔개를_본받으십시오", "시간은_우리를_기다려주지_않아", "세상에_쉬운건없다_근데_못할것도없다", "고개숙이지마_세상을똑바로바라봐", "길을아는것과_그길을걷는것_분명히다르다", "우리가습관을만들면_습관이우리를만든다", "많이하지말고_잘해라", "하고싶은일은_해야하는일다음에", "남에게_상처주지마", "응애_나_애기_고3",
];
